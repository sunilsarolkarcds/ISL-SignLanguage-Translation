...
isl_sign_pos_model=ISLSignPos(pt_body_model=body_estimation.model,pt_hand_model=hand_estimation.model)

def process_frame(frame, body=True, hands=True):
    canvas = copy.deepcopy(frame)

    (candidate, subset,all_hand_peaks)=isl_sign_pos_model(frame)
